...
function getrepoandpublish(username, password, reponame, isUpload){
    $.ajax({
        ...
        success: function(result) {
            ...
            console.log(result, "\n", repo);
            dataTypeToSend = parseInt($("#edit-site-tabs .active a")[0].dataset.type);
            console.log("DATA: ", dataTypeToSend, "\n", $("#edit-site-tabs .active a")[0]);
...
function createfileandpost(username, password, repo){
    ...
    var filecontent = "---\ntitle: helloworld2\n---\nHello World!";
    var filename = "helloworld2.markdown";
